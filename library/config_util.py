...
class BlueprintGenerator:
    ...
    def generate(
        ...
        for dataset_config in sanitized_user_config.get("datasets", []):
            ...
            dataset_blueprints.append(
                DatasetBlueprint(is_dreambooth, is_controlnet, params, subset_blueprints)
            )
    ...
    def generate_params_by_fallbacks(param_klass, fallbacks: Sequence[dict]):
        ...
        params = {
            name: search_value(name_map.get(name, name), fallbacks, default_params.get(name))
...
def generate_dataset_group_by_blueprint(dataset_group_blueprint: DatasetGroupBlueprint):
    ...
    for dataset_blueprint in dataset_group_blueprint.datasets:
        ...
        subsets = [
            subset_klass(**asdict(subset_blueprint.params)) for subset_blueprint in dataset_blueprint.subsets
        ]
